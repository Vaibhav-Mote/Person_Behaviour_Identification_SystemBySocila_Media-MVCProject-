...
<a class="nav-link hk" id="v-pills-profile-tab" href="profileController?registerid=<%=registerids%>" ><i class="fa-solid fa-user fa-lg"></i>Profile</a> 
<a class="nav-link hk" id="v-pills-messages-tab"  href="searchPage" ><i class="fa-solid fa-search"></i>Search</a>
<a class="nav-link hk" id="v-pills-messages-tab"  href="nPost" ><i class="fa-solid fa-plus fa-lg"></i>Create New Post</a>
