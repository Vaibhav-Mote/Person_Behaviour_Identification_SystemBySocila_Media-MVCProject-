...
<body>
	...
	<div class="mainlogin">
		<div class="imgidiv">
			<img id="mainImg" src="resources/asset/loginpimg.jpg">

			<div class="loginformdiv ">
				<form name="frm" action="loginn" method="get" onsubmit="return login()">
					...
					<a  href="registrationPage" id="submitbtn" class="btn btn-primary " >Register</a>
				</form>
